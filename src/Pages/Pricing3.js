...
<div className="inner-page">
        ...
        <div className="col-lg-12">
          <div className="breadcrumb-inne">
            <div className="title-area">
              <h1 className="bread-title">Pricing Plan 3</h1>
  ...
  <div className="rts-pricing-area rts-section-gapTop">
    <div className="container">
      ...
      {/* nav area start */}
      <ul
        className="nav mt--20 nav-tabs pricing-button-one"
        id="myTab"
        role="tablist"
      >
        ...
        <li className="right-image-inner">
          <img src="assets/images/cta/03.png" alt="cta-wrapper" />
        </li>
      </ul>
          ...
          <div className="row g-5 mt--20">
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              ...
              <div className="pricing-style-one">
                ...
                <div className="body">
                  <a href="#" className="rts-btn btn-border-p">
                    Start Free Trial
                  </a>
