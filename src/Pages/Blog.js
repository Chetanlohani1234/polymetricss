        ...
        <div className="col-lg-12">
          <div className="breadcrumb-inne">
            <div className="title-area">
              <h1 className="bread-title">Blog Posts</h1>
    ...
    <div className="container">
      <div className="row g-5">
        ...
        <div className="col-lg-4 col-md-6 col-sm-12 col-12">
          ...
          <div className="single-blog-area-wrapper">
            <a href="blog-details.html" className="thumbnail">
              <img src="assets/images/blog/04.jpg" alt="Blog_images" />
            </a>
            <div className="inner-content">
              <div className="head">
                <span className="tag">Content Write</span>
        ...
        <div className="col-lg-4 col-md-6 col-sm-12 col-12">
          ...
          <div className="single-blog-area-wrapper">
            <a href="blog-details.html" className="thumbnail">
              <img src="assets/images/blog/05.jpg" alt="Blog_images" />
            </a>
            <div className="inner-content">
              <div className="head">
                <span className="tag">blog Content</span>
        ...
        <div className="col-lg-4 col-md-6 col-sm-12 col-12">
          ...
          <div className="single-blog-area-wrapper">
            <a href="blog-details.html" className="thumbnail">
              <img src="assets/images/blog/06.jpg" alt="Blog_images" />
            </a>
            <div className="inner-content">
              <div className="head">
                <span className="tag">Content Write</span>
