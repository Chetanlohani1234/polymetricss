      ...
      <div className="row" style={{marginTop:"50px"}}>
        <div className="col-lg-6">
          <div className="title-left-area">
            <h2 className="title">
            Online Live Chat & Help Desk Software
            </h2>
            <p className="disc">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="title-conter-area">
                                <span className="pre-title-bg">Live Chat</span>
                                <h2 className="title">
                                        ...
                                        <div className="easy-steps-main-wrapper">
                                            ...
                                            <div className="single-steps-area">
                                                ...
                                                <div className="info-wrapper">
                                                    <h5 className="title">Contextual Triggers</h5>
                                                    <p className="disc">
                                            ...
                                            <div className="single-steps-area">
                                                ...
                                                <div className="info-wrapper">
                                                    <h5 className="title">Real-time support</h5>
                                                    <p className="disc">
                                            ...
                                            <div className="single-steps-area">
                                                ...
                                                <div className="info-wrapper">
                                                    <h5 className="title">Easy Integration</h5>
                                                    <p className="disc">
                                            ...
                                            <div className="single-steps-area">
                                                ...
                                                <div className="info-wrapper">
                                                    <h5 className="title">Customizable chat widget</h5>
                                                    <p className="disc">
                                            ...
                                            <div className="single-steps-area">
                                                ...
                                                <div className="info-wrapper">
                                                    <h5 className="title">Single Dashboard for all conversations</h5>
                                                    <p className="disc">
                                            ...
                                            <div className="single-steps-area">
                                                ...
                                                <div className="info-wrapper">
                                                    <h5 className="title">Advanced Reporting</h5>
                                                    <p className="disc">
