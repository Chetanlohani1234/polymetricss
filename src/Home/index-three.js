...
const IndexThree = () => {
  return (
                      ...
                      <div className="col-lg-12">
                          <div className="header-three-area">
                              <a href="index.html" className="logo-area">
                                  <img src="assets/images/logo/07.svg" alt="logo" loading="lazy"/>
                              </a>
    ...
    <div className="gradient-sec-three">
                        ...
                        <div className="banner-three-inner">
                            <div className="inner">
                                ...
                                <div className="button-area-main">
                                    <a href="/AboutOpenUp" className="rts-btn btn-primary">Sign up free</a>
                                    <a href="/AboutOpenUp" className="rts-btn btn-secondary">Start writing free</a>
                                </div>
            ...
            <div className="shape-image">
                <div className="icon-wrapper">
                    <div className="single one">
                        <img src="assets/images/banner/icon/01.png" alt="one-banner" className="one" loading="lazy"/>
                        <span>Content Writing</span>
                    </div>
                    <div className="single two">
                        <img src="assets/images/banner/icon/02.png" alt="one-banner" className="one" loading="lazy"/>
     ...
     {/* <!-- rts banenr area end --> */}
      ...
      {/* <!-- image feature-area start --> */}
        <div className="image-feature-area-three rts-section-gapBottom">
            <div className="shape-bg">
                <img src="assets/images/banner/04.png" alt="images" loading="lazy"/>
            </div>
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="large-imaeg-bottom-banner text-center">
                            <img src="assets/images/banner/02.svg" alt="banenr" loading="lazy"/>
                        </div>
                    </div>
                </div>
                <div className="row g-5 mt--80">
                    <div className="col-lg-4">
                        <div className="single-feature-area-three">
                            <div className="icon">
                                <img src="assets/images/feature/01.svg" alt="icon" loading="lazy"/>
                            </div>
                            <div className="info-wrapper">
                                <span>For blog Writers</span>
                                <h5 className="title">Write blogs 10x faster</h5>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="single-feature-area-three">
                            <div className="icon">
                                <img src="assets/images/feature/02.svg" alt="icon" loading="lazy"/>
                            </div>
                            <div className="info-wrapper">
                                <span>For blog Writers</span>
                                <h5 className="title">Write higher converting Posta</h5>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="single-feature-area-three">
                            <div className="icon">
                                <img src="assets/images/feature/03.svg" alt="icon" loading="lazy"/>
                            </div>
                            <div className="info-wrapper">
                                <span>For blog Writers</span>
                                <h5 className="title">Write more engaging emails</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="row mt--60 g-5">
                    ...
                    <div className="col-lg-4">
                        <div className="single-testimonial-three">
                            <div className="top-area">
                                <div className="author">
                                    <img src="assets/images/team/10.png" alt="team-area" loading="lazy"/>
                                    <div className="info-wrapper-area">
                                        <p>
                                            James
                                        </p>
                    ...
                    <div className="col-lg-4">
                        <div className="single-testimonial-three">
                            <div className="top-area">
                                <div className="author">
                                    <img src="assets/images/team/11.png" alt="team-area" loading="lazy"/>
                                    <div className="info-wrapper-area">
                                        <p>
                                            Sophia
                                        </p>
    ...
    <div className="gradient-sec-three-two">
        {/* <!-- rts-case area start --> */}
        <div className="case-area-three rts-section-gapBottom">
            <div className="shape-img">
                <img className="right" src="assets/images/case/07.png" alt="images" loading="lazy"/>
                <img className="left" src="assets/images/case/08.png" alt="images" loading="lazy"/>
            </div>
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="title-center-three">
                            ...
                            <h2 className="title">Generate AI writing contain <br/>
                ...
                <div className="row g-5 mt--5">
                    ...
                    <div className="col-lg-12">
                        <a href="use-case-2.html" className="rts-btn btn-primary mt--30 m-center">View All Use Cases</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    {/* <!-- how it works area start --> */}
        <div className="how-it-work-area rts-section-gapBottom">
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="title-center-three">
                            <span className="pre">how It work</span>
                            <h2 className="title">Instruct to our AI <br/>
                ...
                <div className="row mt--40">
                    <div className="col-lg-12">
                        ...
                        <div className="working_p-swiper-main-wrapper">
                                            ...
                                            <div className="row g-5 align-items-center">
                                                <div className="col-lg-6">
                                                    <div className="thumbnail-main-wrapper">
                                                        <img src="assets/images/steps/05.svg" alt="images" loading="lazy"/>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 pl--100 pl_md--50 pl_sm--15">
                                                    <div className="steps-main-content-three">
                                                        <span className="trans">01</span>
                                                        <h2 className="title">Select writing <br/>
                                                            template</h2>
                                                        <p className="disc">
                                                            A writing template is a pre-designed format or structure that can be used as a starting point for creating a specific type of written content.
                                                        </p>
                                                        <a href="#" className="rts-btn btn-primary">Start writing free</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="working-process-main-wrapper">
                                            <div className="row g-5 align-items-center">
                                                <div className="col-lg-6">
                                                    <div className="thumbnail-main-wrapper">
                                                        <img src="assets/images/steps/06.svg" alt="images" loading="lazy"/>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 pl--100 pl_md--50 pl_sm--15">
                                                    <div className="steps-main-content-three">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="working-process-main-wrapper">
                                            <div className="row g-5 align-items-center">
                                                <div className="col-lg-6">
                                                    <div className="thumbnail-main-wrapper">
                                                        <img src="assets/images/steps/07.svg" alt="images" loading="lazy"/>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 pl--100 pl_md--50 pl_sm--15">
                                                    <div className="steps-main-content-three">
                            ...
                            <div className="thumbnail-img-left">
                                <img src="assets/images/testimonials/02.png" alt="testimonials" loading="lazy"/>
                            </div>
                        </div>
    ...
    {/* <!-- pricing table three area start --> */}
      <div className="pricing-table-three-area rts-section-gapBottom">
          <div className="container">
              <div className="row">
                  <div className="col-lg-12">
                      <div className="title-center-three">
                          <span className="pre">Pricing</span>
                          <h2 className="title">Start your content <br/>
                              writing with AI</h2>
                      </div>
                  </div>
              </div>
              <div className="row mt--10 g-5">
                  <div className="col-lg-12">
                      {/* <!-- pricing tabs area --> */}
                      <ul className="nav nav-button-area-main nav-tabs" id="myTab" role="tablist">
                          ...
                          <li className="nav-item" role="presentation">
                              <button className="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Annually</button>
                          </li>
                      </ul>
                                  ...
                                  <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                                      ...
                                      <div className="signle-pricing-main-con-three left-area">
                                          <div className="thumbnail-img">
                                              <img src="assets/images/testimonials/01.png" alt="img" loading="lazy"/>
                                          </div>
                                  ...
                                  <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                                      <div className="single-prcing-three-main-wrapper">
                                          <div className="head-area">
                                              ...
                                              <h2 className="title">Free<span>/month</span> </h2>
                                          </div>
                                          <div className="body">
                                              <p className="disc">A simple pricing plan includes a set of clearly defined pricing tiers.</p>
                                              ...
                                              <a href="#" className="rts-btn btn-border">Sing Up For Free</a>
                                          </div>
                                      </div>
                                  </div>
                                  <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                                      <div className="single-prcing-three-main-wrapper active">
                                          <div className="head-area">
                                              ...
                                              <h2 className="title">$199<span>/month</span> </h2>
                                          </div>
                                          <div className="body">
                                              <p className="disc">A simple pricing plan includes a set of clearly defined pricing tiers.</p>
                                              <div className="check-only">
                                  ...
                                  <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                                      <div className="single-prcing-three-main-wrapper">
                                          <div className="head-area">
                                              ...
                                              <h2 className="title">$99<span>/month</span> </h2>
                                          </div>
                                          <div className="body">
                                              <p className="disc">A simple pricing plan includes a set of clearly defined pricing tiers.</p>
                                              <div className="check-only">
                                              ...
                                              <a href="#" className="rts-btn btn-border">Request a Demo</a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
        ...
        <div className="container">
            <div className="row">
                <div className="title-center-three">
                    ...
                    <h2 className="title">Questions About our OpenUp? <br/>
                        We have Answers!</h2>
                </div>
            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-12 col-sm-12">
                                <div className="content-main-wrapper-three">
                                    ...
                                    <p className="disc">
                                        Write 10x faster, engage your audience, & never struggle with <br/> the blank page again.
                                    </p>
                                    <a href="#" className="rts-btn btn-primary">Start writing free</a>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12 col-sm-12 mt_sm--30">
                                <div className="thumbnail-three">
                                    <img src="assets/images/cta/05.png" alt="cta" loading="lazy"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-12">
                    ...
                    <div className="footer-one-main-wrapper">
                        ...
                        <div className="footer-singl-wized left-logo">
                            <div className="head">
                                <a href="#">
                                    <img src="assets/images/logo/05.svg" alt="logo" loading="lazy"/>
                                </a>
                            </div>
                            <div className="body">
                                <p className="dsic">
