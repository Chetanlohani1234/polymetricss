                        ...
                        <div class="col-lg-12">
                            <div class="main-4-header-wrapper">
                                <a href="index.html" class="logo">
                                    <img src="assets/images/logo/06.svg" alt="logo" loading="lazy"/>
                                </a>
                                {/* <!-- nav --> */}
                                <div class="nav-area-main d-xl-block d-lg-block d-md-none d-sm-none d-none">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a class="links-main" href="/UseCase">Use Cases</a></li>
                                            ...
                                            <li><a class="links-main" href="/Contact">Contact</a></li>
                                        </ul>
                                    </nav>
                                </div>
                                {/* <!-- nav end --> */}
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="banner-four-content five">
                            ...
                            <div class="title-area">
                                ...
                                <img src="assets/images/banner/09.png" alt="shape" loading="lazy"/>
                            </div>
                            <p class="disc">
                            ...
                            <div class="button-area-main">
                                <a href="/AboutOpenUp" class="rts-btn btn-primary">Start Now for Free</a>
                                <a href="/Contact" class="rts-btn btn-border-p">Request Demo</a>
                            </div>
                            <div class="voice-languages-wrapper">
                                <p>AI Voices Toolkit <a href="#">120+ Language</a></p>
                                <div class="img-wrapper">
                                    <img class="one" src="assets/images/banner/user/07.png" alt="banner-user" loading="lazy"/>
                                    <img class="two" src="assets/images/banner/user/08.png" alt="banner-user" loading="lazy"/>
                                    <img class="three" src="assets/images/banner/user/09.png" alt="banner-user" loading="lazy"/>
                                    <img class="four" src="assets/images/banner/user/10.png" alt="banner-user" loading="lazy"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="banner-five-thumbnail">
                            <img src="assets/images/banner/07.png" alt="banenr" loading="lazy"/>
                            {/* <!-- single mp3 area start --> */}
                            <div class="single-mp3-start">
                                <img class="man" src="assets/images/banner/08.png" alt="banner" loading="lazy"/>
                                <div class="mid">
                                    <p>Gwyneth Paltrow</p>
                                    <span>English Female Voice</span>
                                </div>
                                <div id="ppbutton7" class="ppbutton fa fa-plays icon-play" data-src="assets/images/mp3/02.mp3">
                                    <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 3C7.53125 3 8 3.46875 8 4V12C8 12.5625 7.46875 13 6.96875 13C6.4375 13 6 12.5625 6 12V4C6 3.46875 6.4375 3 7 3ZM1 7C1.53125 7 2 7.46875 2 8C2 8.5625 1.46875 9 0.96875 9C0.4375 9 0 8.5 0 8C0 7.46875 0.4375 7 1 7ZM10 0C10.5312 0 11 0.46875 11 1V15C11 15.5625 10.4688 16 9.96875 16C9.4375 16 9 15.5625 9 15V1C9 0.46875 9.4375 0 10 0ZM4 6C4.53125 6 5 6.46875 5 7V9C5 9.5625 4.46875 10 3.96875 10C3.4375 10 3 9.5625 3 9V7C3 6.46875 3.4375 6 4 6ZM19 7C19.5312 7 20 7.53125 20 8.03125C20 8.5625 19.5312 9 19 9C18.4375 9 18 8.5 18 8C18 7.46875 18.4375 7 19 7ZM13 4C13.5312 4 14 4.46875 14 5V11C14 11.5625 13.4688 12 12.9688 12C12.4375 12 12 11.5625 12 11V5C12 4.46875 12.4375 4 13 4ZM16 2C16.5312 2 17 2.46875 17 3V13C17 13.5625 16.5312 14 15.9688 14C15.4375 14 15 13.5625 15 13V3C15 2.46875 15.4375 2 16 2Z" fill="white" />
                                    </svg>
                                </div>
                            </div>
                            {/* <!-- single mp3 area end --> */}
                            ...
                            <div class="single-mp3-start left">
                                ...
                                <div id="ppbutton6" class="ppbutton fa fa-plays icon-play" data-src="assets/images/mp3/03.mp3">
                                    <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 3C7.53125 3 8 3.46875 8 4V12C8 12.5625 7.46875 13 6.96875 13C6.4375 13 6 12.5625 6 12V4C6 3.46875 6.4375 3 7 3ZM1 7C1.53125 7 2 7.46875 2 8C2 8.5625 1.46875 9 0.96875 9C0.4375 9 0 8.5 0 8C0 7.46875 0.4375 7 1 7ZM10 0C10.5312 0 11 0.46875 11 1V15C11 15.5625 10.4688 16 9.96875 16C9.4375 16 9 15.5625 9 15V1C9 0.46875 9.4375 0 10 0ZM4 6C4.53125 6 5 6.46875 5 7V9C5 9.5625 4.46875 10 3.96875 10C3.4375 10 3 9.5625 3 9V7C3 6.46875 3.4375 6 4 6ZM19 7C19.5312 7 20 7.53125 20 8.03125C20 8.5625 19.5312 9 19 9C18.4375 9 18 8.5 18 8C18 7.46875 18.4375 7 19 7ZM13 4C13.5312 4 14 4.46875 14 5V11C14 11.5625 13.4688 12 12.9688 12C12.4375 12 12 11.5625 12 11V5C12 4.46875 12.4375 4 13 4ZM16 2C16.5312 2 17 2.46875 17 3V13C17 13.5625 16.5312 14 15.9688 14C15.4375 14 15 13.5625 15 13V3C15 2.46875 15.4375 2 16 2Z" fill="white" />
                                    </svg>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt--50">
                        <div class="brand-area-4">
                            <img src="assets/images/brand/01.png" alt="brand-area" loading="lazy"/>
                            <img src="assets/images/brand/02.png" alt="brand-area" loading="lazy"/>
                            <img src="assets/images/brand/03.png" alt="brand-area" loading="lazy"/>
                            <img src="assets/images/brand/04.png" alt="brand-area" loading="lazy"/>
                            <img src="assets/images/brand/05.png" alt="brand-area" loading="lazy"/>
                            <img src="assets/images/brand/06.png" alt="brand-area" loading="lazy"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-inner-main-four">
                            ...
                            <a href="/AboutOpenUp" class="rts-btn btn-primary">Find Your Voice</a>
                        </div>
                    </div>
                    <div class="col-lg-6 mt_md--50 mt_sm--50">
                        {/* <!-- abot image 5 --> */}
                        <div class="about-image-thu-5">
                            <img src="assets/images/about/04.png" alt="about" loading="lazy"/>

                            <div class="small-image-area mt--30">
                                {/* <!-- single image --> */}
                                <div class="small-image">
                                    <img src="assets/images/about/c-img/01.png" alt="countryimage" loading="lazy"/>
                                    <p>Usa English</p>
                                </div>
                                {/* <!-- single image end --> */}
                                {/* <!-- single image --> */}
                                <div class="small-image">
                                    <img src="assets/images/about/c-img/02.png" alt="countryimage" loading="lazy"/>
                                    <p>British English</p>
                                </div>
                                {/* <!-- single image end --> */}
                                {/* <!-- single image --> */}
                                <div class="small-image">
                                    <img src="assets/images/about/c-img/03.png" alt="countryimage" loading="lazy"/>
                                    <p>Italian</p>
                                </div>
                                {/* <!-- single image end --> */}
                                {/* <!-- single image --> */}
                                <div class="small-image">
                                    <img src="assets/images/about/c-img/04.png" alt="countryimage" loading="lazy"/>
                                    <p>Hindi</p>
                                </div>
                                {/* <!-- single image end --> */}
                                {/* <!-- single image --> */}
                                <div class="small-image">
                                    <img src="assets/images/about/c-img/05.png" alt="countryimage" loading="lazy"/>
                                    <p>French</p>
                                </div>
                                {/* <!-- single image end --> */}
                                {/* <!-- single image --> */}
                                <div class="small-image">
                                    <img src="assets/images/about/c-img/06.png" alt="countryimage" loading="lazy"/>
                                    <p>German</p>
                                </div>
                                {/* <!-- single image end --> */}
                                ...
                                <div class="image-author-language">
                                    <img src="assets/images/banner/user/14.png" alt=""/>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-main-center-4">
                            ...
                            <p class="disc">
                                Discover all kinds of content OpenUp can help you create instantly with tailored AI Voices.
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="thumbnail-image-large">
                                                    <img src="assets/images/brand/08.jpg" alt="brand" loading="lazy"/>
                                                ...
                                                <div class="right-content">
                                                    <div class="inner">
                                                        ...
                                                        <div class="bottom-area">
                                                            <div class="authore">
                                                                <img src="assets/images/brand/09.png" alt="brand" loading="lazy"/>
                        ...
                        <div class="signle-voice-generator-case">
                            <div class="icon">
                                <svg width="27" height="18" viewBox="0 0 27 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18 2.25V15.75C18 17.0156 16.9688 18 15.75 18H2.25C0.984375 18 0 17.0156 0 15.75V2.25C0 1.03125 0.984375 0 2.25 0H15.75C16.9688 0 18 1.03125 18 2.25ZM27 3V15.0469C27 16.2188 25.5938 16.9219 24.6094 16.2656L19.5 12.7031V5.34375L24.6094 1.78125C25.5938 1.125 27 1.82812 27 3Z" fill="#083A5E" />
                                </svg>
                            </div>
                        ...
                        <div class="signle-voice-generator-case">
                            <div class="icon">
                                <svg width="18" height="24" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 16.5C6.46875 16.5 4.5 14.4844 4.5 12V4.5C4.5 2.01562 6.46875 0 9 0C11.4844 0 13.5 2.01562 13.5 4.5H9.75C9.32812 4.5 9 4.82812 9 5.25C9 5.625 9.32812 6 9.75 6H13.5V7.5H9.75C9.32812 7.5 9 7.875 9 8.25C9 8.67188 9.32812 9 9.75 9H13.5V10.5H9.75C9.32812 10.5 9 10.875 9 11.25C9 11.6719 9.32812 12 9.75 12H13.5C13.5 14.5312 11.4844 16.5 9 16.5ZM16.125 9C16.7344 9 17.25 9.51562 17.25 10.125V12C17.25 16.1719 14.1094 19.6406 10.125 20.2031V21.75H12C12.8438 21.75 13.5 22.5 13.4531 23.3438C13.4531 23.7188 13.125 24 12.75 24H5.25C4.82812 24 4.5 23.7188 4.5 23.3438C4.45312 22.5 5.10938 21.75 6 21.75H7.875V20.1094C3.70312 19.5469 0.75 15.7969 0.75 11.625V10.125C0.75 9.51562 1.21875 9 1.875 9C2.48438 9 3 9.51562 3 10.125V11.7656C3 14.9062 5.48438 17.8125 8.57812 18C12.0938 18.2344 15 15.4688 15 12V10.125C15 9.51562 15.4688 9 16.125 9Z" fill="#7877FF" />
                                </svg>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="nav-button-voice-bot mt--40">
                            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                                <li role="presentation" id="ppbutton2" class="ppbutton fa fa-plays nav-item" data-src="assets/images/mp3/02.mp3">
                                    <div class="nav-link active" id="homes-tab" data-bs-toggle="tab" data-bs-target="#homes" role="tab" aria-controls="homes" aria-selected="true">
                                        <div class="press-area">
                                            <img src="assets/images/team/19.png" alt="tte4am" loading="lazy"/>
                                            <div class="info">
                                                <h6>Michael</h6>
                                            ...
                                            <div class="icon-audio">
                                                <svg width="46" height="23" viewBox="0 0 46 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0.859814 7.4884C0.384981 7.4884 0 7.87338 0 8.34822V13.6791C0 14.1539 0.384981 14.5389 0.859814 14.5389C1.33465 14.5389 1.71963 14.1539 1.71963 13.6791V8.34822C1.71963 7.87338 1.33465 7.4884 0.859814 7.4884Z" fill="#083A5E" />
                                                    <path d="M4.26471 3.14746C3.78987 3.14746 3.40489 3.53244 3.40489 4.00727V18.0222C3.40489 18.4971 3.78987 18.882 4.26471 18.882C4.73954 18.882 5.12452 18.4971 5.12452 18.0222V4.00727C5.12452 3.53244 4.73954 3.14746 4.26471 3.14746Z" fill="#083A5E" />
                                                    <path d="M7.66946 4.65173C7.19463 4.65173 6.80965 5.03671 6.80965 5.51155V16.5172C6.80965 16.992 7.19463 17.377 7.66946 17.377C8.14429 17.377 8.52927 16.992 8.52927 16.5172V5.51155C8.52927 5.03671 8.14429 4.65173 7.66946 4.65173Z" fill="#083A5E" />
                                                    <path d="M11.0744 7.4884C10.5995 7.4884 10.2146 7.87338 10.2146 8.34822V13.6791C10.2146 14.1539 10.5995 14.5389 11.0744 14.5389C11.5492 14.5389 11.9342 14.1539 11.9342 13.6791V8.34822C11.9342 7.87338 11.5492 7.4884 11.0744 7.4884Z" fill="#083A5E" />
                                                    <path d="M14.488 0C14.0131 0 13.6282 0.384981 13.6282 0.859813V21.1686C13.6282 21.6434 14.0131 22.0284 14.488 22.0284C14.9628 22.0284 15.3478 21.6434 15.3478 21.1686V0.859813C15.3478 0.384981 14.9628 0 14.488 0Z" fill="#083A5E" />
                                                    <path d="M17.8927 4.19604C17.4179 4.19604 17.0329 4.58103 17.0329 5.05586V16.9729C17.0329 17.4477 17.4179 17.8327 17.8927 17.8327C18.3676 17.8327 18.7525 17.4477 18.7525 16.9729V5.05586C18.7525 4.58103 18.3676 4.19604 17.8927 4.19604Z" fill="#083A5E" />
                                                    <path d="M21.2803 5.63184C20.8055 5.63184 20.4205 6.01682 20.4205 6.49165V15.5369C20.4205 16.0117 20.8055 16.3967 21.2803 16.3967C21.7552 16.3967 22.1402 16.0117 22.1402 15.5369V6.49165C22.1402 6.01682 21.7552 5.63184 21.2803 5.63184Z" fill="#083A5E" />
                                                    <path d="M24.7197 7.4884C24.2448 7.4884 23.8599 7.87338 23.8599 8.34822V13.6791C23.8599 14.1539 24.2448 14.5389 24.7197 14.5389C25.1945 14.5389 25.5795 14.1539 25.5795 13.6791V8.34822C25.5795 7.87338 25.1945 7.4884 24.7197 7.4884Z" fill="#083A5E" />
                                                    <path d="M28.1073 5.63184C27.6324 5.63184 27.2475 6.01682 27.2475 6.49165V15.5369C27.2475 16.0117 27.6324 16.3967 28.1073 16.3967C28.5821 16.3967 28.9671 16.0117 28.9671 15.5369V6.49165C28.9671 6.01682 28.5821 5.63184 28.1073 5.63184Z" fill="#083A5E" />
                                                    <path d="M31.5122 4.19604C31.0373 4.19604 30.6524 4.58103 30.6524 5.05586V16.9729C30.6524 17.4477 31.0373 17.8327 31.5122 17.8327C31.987 17.8327 32.372 17.4477 32.372 16.9729V5.05586C32.372 4.58103 31.987 4.19604 31.5122 4.19604Z" fill="#083A5E" />
                                                    <path d="M34.9256 0C34.4508 0 34.0658 0.384981 34.0658 0.859813V21.1686C34.0658 21.6434 34.4508 22.0284 34.9256 22.0284C35.4005 22.0284 35.7855 21.6434 35.7855 21.1686V0.859813C35.7855 0.384981 35.4005 0 34.9256 0Z" fill="#083A5E" />
                                                    <path d="M38.3304 4.65173C37.8556 4.65173 37.4706 5.03671 37.4706 5.51155V16.5172C37.4706 16.992 37.8556 17.377 38.3304 17.377C38.8052 17.377 39.1902 16.992 39.1902 16.5172V5.51155C39.1902 5.03671 38.8052 4.65173 38.3304 4.65173Z" fill="#083A5E" />
                                                    <path d="M41.7353 7.4884C41.2605 7.4884 40.8755 7.87338 40.8755 8.34822V13.6791C40.8755 14.1539 41.2605 14.5389 41.7353 14.5389C42.2101 14.5389 42.5951 14.1539 42.5951 13.6791V8.34822C42.5951 7.87338 42.2101 7.4884 41.7353 7.4884Z" fill="#083A5E" />
                                                    <path d="M45.1402 7.4884C44.6654 7.4884 44.2804 7.87338 44.2804 8.34822V13.6791C44.2804 14.1539 44.6654 14.5389 45.1402 14.5389C45.615 14.5389 46 14.1539 46 13.6791V8.34822C46 7.87338 45.615 7.4884 45.1402 7.4884Z" fill="#083A5E" />
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li role="presentation" id="ppbutton3" class="ppbutton fa fa-plays nav-item" data-src="assets/images/mp3/03.mp3">
                                    <div class="nav-link" id="profiles-tab" data-bs-toggle="tab" data-bs-target="#profiles" role="tab" aria-controls="profiles" aria-selected="false">
                                        <div class="press-area">
                                            <img src="assets/images/team/20.png" alt="tte4am" loading="lazy"/>
                                            <div class="info">
                                                <h6>Mr.Alamin</h6>
                                                <span class="one">Emotions</span>
                                                <span class="two">Audiobooks</span>
                                ...
                                <li role="presentation" id="ppbutton4" class="ppbutton fa fa-plays nav-item" data-src="assets/images/mp3/04.mp3">
                                    <div class="nav-link" id="contactf-tab" data-bs-toggle="tab" data-bs-target="#contactf" role="tab" aria-controls="contact" aria-selected="false">
                                        <div class="press-area">
                                            <img src="assets/images/team/21.png" alt="tte4am" loading="lazy"/>
                                            <div class="info">
                                                <h6>Mr.Ashik</h6>
                                                <span class="one">Emotions</span>
                                                <span class="two">Audiobooks</span>
                                ...
                                <li role="presentation" id="ppbutton5" class="ppbutton fa fa-plays nav-item" data-src="assets/images/mp3/01.mp3">
                                    <div class="nav-link" id="about-tab" data-bs-toggle="tab" data-bs-target="#about" role="tab" aria-controls="about" aria-selected="false">
                                        <div class="press-area">
                                            <img src="assets/images/team/22.png" alt="tte4am" loading="lazy"/>
                                            <div class="info">
                                                <h6>Mr.Banna</h6>
                                                <span class="one">Emotions</span>
                                                <span class="two">Audiobooks</span>
                        ...
                        <div class="tab-content" id="myTabsContents">
                            <div class="tab-pane fade show active" id="homes" role="tabpanel" aria-labelledby="homes-tab">
                                <div class="thumbnail-voice-bot">
                                    <img src="assets/images/about/05.png" alt="lazy" loading="lazy"/>
                                </div>
                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <div class="single-team-area">
                                            <img src="assets/images/team/brand/quote.png" alt="" class="quote" loading="lazy"/>
                                            <div class="star">
                                            ...
                                            <div class="authore-area">
                                                <div class="author">
                                                    <img src="assets/images/team/13.png" alt="team" loading="lazy"/>
                                                    <div class="info">
                                                        <p>Samuel</p>
                                                        <span>Blogger</span>
                                                    </div>
                                                </div>
                                                <img src="assets/images/team/brand/01.png" alt="" loading="lazy"/>
                                            </div>
                                        </div>
                                        {/* <!-- single swiepr end --> */}
                                    </div>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="single-team-area">
                                            ...
                                            <div class="authore-area">
                                                <div class="author">
                                                    <img src="assets/images/team/16.png" alt="team" loading="lazy"/>
                                                    <div class="info">
                                                        <p>Rokib</p>
                                                        <span>Blogger</span>
                                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="single-team-area">
                                            ...
                                            <div class="authore-area">
                                                <div class="author">
                                                    <img src="assets/images/team/11.png" alt="team" loading="lazy"/>
                                                    <div class="info">
                                                        <p>Mr.Alamin</p>
                                                        <span>Blogger</span>
                                                    </div>
                                                </div>
                                                <img src="assets/images/team/brand/01.png" alt="img" loading="lazy"/>
                                            </div>
                                        </div>
                                        {/* <!-- single swiepr end --> */}
                                    </div>
                                    <div class="swiper-slide">
                                        {/* <!-- single swiepr start --> */}
                                        <div class="single-team-area">
                                            <img src="assets/images/team/brand/quote.png" alt="img" loading="lazy" class="quote"/>
                                            <div class="star">
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                            ...
                                            <div class="authore-area">
                                                <div class="author">
                                                    <img src="assets/images/team/12.png" alt="team" loading="lazy"/>
                                                    <div class="info">
                                                        <p>Ashik</p>
                                                        <span>Blogger</span>
                                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        {/* <!-- single swiepr start --> */}
                                        <div class="single-team-area">
                                            <img src="assets/images/team/brand/quote.png" alt="team" class="quote"/>
                                            <div class="star">
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                            ...
                                            <div class="authore-area">
                                                <div class="author">
                                                    <img src="assets/images/team/01.png" alt="team" loading="lazy"/>
                                                    <div class="info">
                                                        <p>Mr.Sajib</p>
                                                        <span>Blogger</span>
                                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        {/* <!-- single swiepr start --> */}
                                        <div class="single-team-area">
                                            <img src="assets/images/team/brand/quote.png" alt="img" class="quote"/>
                                            <div class="star">
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                                <i class="fa-sharp fa-solid fa-star"></i>
                                            ...
                                            <div class="authore-area">
                                                <div class="author">
                                                    <img src="assets/images/team/09.png" alt="team" loading="lazy"/>
                                                    <div class="info">
                                                        <p>Mr. Banna</p>
                                                        <span>Blogger</span>
                                                    </div>
                ...
                {/* <!-- tabs area start --> */}
                    <div class="tab-area-pricing-two mt--30">
                        <ul class="nav nav-tabs pricing-button-one two" id="myTabsContent" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="" id="nav-home-tabfs" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Monthly Pricing</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="active" id="nav-profile-tabfs" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Annual Pricing</button>
                            </li>
                            <li class="save-badge">
                                <span>SAVE 25%</span>
                            </li>
                        ...
                        <div class="tab-content mt--20" id="myTabContent">
                            ...
                            <div class="tab-pane fade active show" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tabfs">
                                <div class="row g-5 mt--10">
                                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                        {/* <!-- single pricing-area --> */}
                                        <div class="single-pricing-single-two">
                    ...
                    <div class="row main-cta-five">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="right-image-thumbnail">
                                <img src="assets/images/cta/06.png" alt="right-imaeg" loading="lazy"/>
                            </div>
            ...
            <nav class="nav-main mainmenu-nav mt--30">
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    ...
                    <li class="has-droupdown parent">
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a class="mobile-menu-link" href="/ProductDetails">Product Details</a></li>
                            <li><a class="mobile-menu-link" href="/Cart">Cart</a></li>
                            <li><a class="mobile-menu-link" href="/Checkout">Checkout</a></li>
                            <li><a class="mobile-menu-link" href="/MyAccount">My Account</a></li>
                        </ul>
                    </li>
                    <li class="parent">
