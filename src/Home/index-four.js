                    ...
                    <div class="col-lg-12">
                        <div class="main-4-header-wrapper">
                            ...
                            <div class="nav-area-main d-xl-block d-lg-block d-md-none d-sm-none d-none">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a class="links-main" href="/Feature">Feature</a></li>
                                        <li class="has-dropdown">
                            ...
                            <div class="button-area">
                                <a href="/Login" class="rts-btn btn-lonly mr--30">Sign in</a>
                                <a href="/AboutOpenUp" class="rts-btn btn-blur">Get Started</a>
                            </div>
            ...
            <div class="row align-items-start">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-xl-1 order-lg-1 order-md-2 order-sm-2 order-2">
                    <div class="banner-four-content mt--100 mt_md--50 mt_sm--50">
                        ...
                        <div class="button-area-main">
                            <a href="/AboutOpenUp" class="rts-btn btn-primary">Get Started</a>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-xl-2 order-lg-2 order-md-1 order-sm-1 order-1 mt--20">
                    <div class="thumbnail-banner-right">
                        <img src="assets/images/banner/05.png" alt="banenr" loading="lazy"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-inner-main-four">
                        ...
                        <a href="/AboutOpenUp" class="rts-btn btn-primary">Try Now</a>
                    </div>
                </div>
                <div class="col-lg-6 mt_sm--50">
                    <div class="thumbnail-main">
                        <img src="assets/images/about/03.png" alt="thumbnail" loading="lazy"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt--50">
                <div class="col-xl-3 col-lg-6">
                    <div class="left-area-core-feature-image">
                        <img src="assets/images/case/09.png" alt="case" loading="lazy"/>
                    </div>
                </div>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                <div class="thumbnail-core-feature">
                                    <img src="assets/images/case/10.png" alt="case-thumbnail" loading="lazy"/>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                <div class="thumbnail-core-feature">
                                    <img src="assets/images/case/11.svg" alt="case-thumbnail" loading="lazy"/>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                <div class="thumbnail-core-feature">
                                    <img src="assets/images/case/12.svg" alt="case-thumbnail" loading="lazy"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper mySwiper-t4">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-team-area">
                                        ...
                                        <div class="authore-area">
                                            ...
                                            <img src="assets/images/team/brand/01.png" alt="image" loading="lazy"/>
                                        </div>
                                    </div>
                                    {/* <!-- single swiepr end --> */}
                                </div>
                                <div class="swiper-slide">
                                    {/* <!-- single swiepr start --> */}
                                    <div class="single-team-area">
                                        <img src="assets/images/team/brand/quote.png" alt="images" class="quote" loading="lazy"/>
                                        <div class="star">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                        ...
                                        <div class="authore-area">
                                            ...
                                            <img src="assets/images/team/brand/01.png" alt="team" loading="lazy"/>
                                        </div>
                                    </div>
                                    {/* <!-- single swiepr end --> */}
                                </div>
                                <div class="swiper-slide">
                                    {/* <!-- single swiepr start --> */}
                                    <div class="single-team-area">
                                        <img src="assets/images/team/brand/quote.png" alt="image" class="quote" loading="lazy"/>
                                        <div class="star">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                ...
                                <div class="swiper-slide">
                                    {/* <!-- single swiepr start --> */}
                                    <div class="single-team-area">
                                        <img src="assets/images/team/brand/quote.png" alt="image" class="quote"/>
                                        <div class="star">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                        ...
                                        <div class="authore-area">
                                            ...
                                            <img src="assets/images/team/brand/01.png" alt="tream" loading="lazy"/>
                                        </div>
                                    </div>
                                    {/* <!-- single swiepr end --> */}
                                </div>
        ...
        <div class="container">
            ...
            <div class="row g-5 mt--30">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-blog-area-start">
                        <a href="#" class="thumbnail">
                            <img src="assets/images/blog/14.jpg" alt="blog-area"/>
                        </a>
                        <div class="inner-content">
                            <div class="meta-area">
                                <div class="left">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-blog-area-start">
                        <a href="#" class="thumbnail">
                            <img src="assets/images/blog/15.jpg" alt="blog-area"/>
                        </a>
                        <div class="inner-content">
                            <div class="meta-area">
                                <div class="left">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="brand-area-4">
                        <img src="assets/images/brand/01.png" alt="brand-area"/>
                        <img src="assets/images/brand/02.png" alt="brand-area"/>
                        <img src="assets/images/brand/03.png" alt="brand-area"/>
                        <img src="assets/images/brand/04.png" alt="brand-area"/>
                        <img src="assets/images/brand/05.png" alt="brand-area"/>
                    </div>
                </div>
            </div>
        </div>
